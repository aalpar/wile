...
func TestInitApplyFrame_AllocatesBindingsWithoutCopy(t *testing.T) {
...
func TestInitApplyFrame_ReusePooledCapacity(t *testing.T) {
	tl := NewTopLevelEnvironment()
	parent := tl.Runtime()
...
func TestInitApplyFrame_SharesKeysMap(t *testing.T) {
	tl := NewTopLevelEnvironment()
	parent := tl.Runtime()
