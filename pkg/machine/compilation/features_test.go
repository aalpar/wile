...
func TestFeatureIdentifier_IsSatisfied(t *testing.T) {
	...
	qt.Assert(t, req.IsSatisfied(context.Background(), nil, nil, nil), qt.IsTrue)

	req2 := NewFeatureIdentifier("nonexistent")
	qt.Assert(t, req2.IsSatisfied(context.Background(), nil, nil, nil), qt.IsFalse)
}
...
func TestAndRequirement_IsSatisfied(t *testing.T) {
	...
	qt.Assert(t, req3.IsSatisfied(context.Background(), nil, nil, nil), qt.IsTrue)
}
...
func TestOrRequirement_IsSatisfied(t *testing.T) {
	...
	qt.Assert(t, req3.IsSatisfied(context.Background(), nil, nil, nil), qt.IsFalse)
}
...
func TestComplexFeatureRequirements(t *testing.T) {
	...
	qt.Assert(t, req2.IsSatisfied(context.Background(), nil, nil, nil), qt.IsTrue)
...
func TestFeatureRequirementIsSatisfied(t *testing.T) {
	...
	qt.Assert(t, r7rsFeat.IsSatisfied(context.Background(), registry, nil, nil), qt.IsTrue)

	nonExistent := NewFeatureIdentifier("nonexistent-feature")
	qt.Assert(t, nonExistent.IsSatisfied(context.Background(), registry, nil, nil), qt.IsFalse)
	...
	qt.Assert(t, andReqFail.IsSatisfied(context.Background(), registry, nil, nil), qt.IsFalse)
...
func TestLibraryRequirementWithFSResolver(t *testing.T) {
	...
	qt.Assert(t, req.IsSatisfied(context.Background(), registry, resolver, nil), qt.IsTrue)
	...
	qt.Assert(t, req2.IsSatisfied(context.Background(), registry, resolver2, nil), qt.IsTrue)
}
