...
func addBytevectors(r *registry.PrimitiveRegistry) error {
	r.AddPrimitives([]registry.PrimitiveSpec{
		{Name: "make-bytevector", ParamCount: 2, IsVariadic: true, Impl: PrimMakeBytevector,
			...
			ParamTypes: []values.TypeConstraint{values.TypeInteger, values.TypeInteger}, ReturnType: values.TypeByteVector},
		{Name: "bytevector", ParamCount: 1, IsVariadic: true, Impl: PrimBytevector,
			...
			ParamTypes: []values.TypeConstraint{values.TypeInteger}, ReturnType: values.TypeByteVector},
		{Name: "bytevector-length", ParamCount: 1, Impl: PrimBytevectorLength,
			...
			ParamTypes: []values.TypeConstraint{values.TypeByteVector}, ReturnType: values.TypeInteger},
		{Name: "bytevector-u8-ref", ParamCount: 2, Impl: PrimBytevectorU8Ref,
			...
			ParamTypes: []values.TypeConstraint{values.TypeByteVector, values.TypeInteger}, ReturnType: values.TypeInteger},
		{Name: "bytevector-u8-set!", Mutates: true, ParamCount: 3, Impl: PrimBytevectorU8Set,
			...
			ParamTypes: []values.TypeConstraint{values.TypeByteVector, values.TypeInteger, values.TypeInteger}, ReturnType: values.TypeVoid},
		{Name: "bytevector-copy", ParamCount: 2, IsVariadic: true, Impl: PrimBytevectorCopy,
			...
			ParamTypes: []values.TypeConstraint{values.TypeByteVector, values.TypeInteger}, ReturnType: values.TypeByteVector},
		{Name: "bytevector-copy!", Mutates: true, ParamCount: 4, IsVariadic: true, Impl: PrimBytevectorCopyBang,
			...
			ParamTypes: []values.TypeConstraint{values.TypeByteVector, values.TypeInteger, values.TypeByteVector, values.TypeInteger}, ReturnType: values.TypeVoid},
	...
	r.AddPrimitives([]registry.PrimitiveSpec{
		{Name: "utf8->string", ParamCount: 2, IsVariadic: true, Impl: PrimUtf8ToString,
			...
			ParamTypes: []values.TypeConstraint{values.TypeByteVector, values.TypeInteger}, ReturnType: values.TypeString,
		...
		{Name: "string->utf8", ParamCount: 2, IsVariadic: true, Impl: PrimStringToUtf8,
			...
			ParamTypes: []values.TypeConstraint{values.TypeString, values.TypeInteger}, ReturnType: values.TypeByteVector,
