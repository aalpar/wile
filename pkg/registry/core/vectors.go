...
func addVectors(r *registry.PrimitiveRegistry) error {
	r.AddPrimitives([]registry.PrimitiveSpec{
		{Name: "make-vector", ParamCount: 2, IsVariadic: true, Impl: PrimMakeVector,
			...
			ParamTypes: []values.TypeConstraint{values.TypeInteger, values.TypeAny}, ReturnType: values.TypeVector,
		...
		{Name: "vector-length", ParamCount: 1, Impl: PrimVectorLength,
			...
			ParamTypes: []values.TypeConstraint{values.TypeVector}, ReturnType: values.TypeInteger},
		...
		{Name: "vector->list", ParamCount: 2, IsVariadic: true, Impl: PrimVectorToList,
			...
			ParamTypes: []values.TypeConstraint{values.TypeVector, values.TypeInteger}, ReturnType: values.TypeList},
		...
		{Name: "vector-copy!", Mutates: true, ParamCount: 3, IsVariadic: true, Impl: PrimVectorCopyTo,
			...
			ParamTypes: []values.TypeConstraint{values.TypeVector, values.TypeInteger, values.TypeAny}, ReturnType: values.TypeVoid},
		{Name: "vector-fill!", Mutates: true, ParamCount: 3, IsVariadic: true, Impl: PrimVectorFill,
		...
		{Name: "vector->string", ParamCount: 2, IsVariadic: true, Impl: PrimVectorToString,
			...
			ParamTypes: []values.TypeConstraint{values.TypeVector, values.TypeInteger}, ReturnType: values.TypeString},
		{Name: "string->vector", ParamCount: 2, IsVariadic: true, Impl: PrimStringToVector,
			...
			ParamTypes: []values.TypeConstraint{values.TypeString, values.TypeInteger}, ReturnType: values.TypeVector},
