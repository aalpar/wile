...
var primBenchCases = []primBenchCase{
	...
	{"AppendLong", "(begin (define bench-la (make-list 50 1)) (define bench-lb (make-list 50 2)))", "(append bench-la bench-lb)"},
	{"AppendMany", "(begin (define bench-m1 (make-list 10 1)) (define bench-m2 (make-list 10 2)) (define bench-m3 (make-list 10 3)) (define bench-m4 (make-list 10 4)) (define bench-m5 (make-list 10 5)))", "(append bench-m1 bench-m2 bench-m3 bench-m4 bench-m5)"},
	{"Reverse", "", "(reverse '(1 2 3 4 5))"},
	{"ReverseLong", "(define bench-rev (make-list 50 7))", "(reverse bench-rev)"},
