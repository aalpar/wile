...
(Also completed and moved to `memory/`: `2026-05-09-environment-structural-reduction.md` (Phases 1–9, PR #730; Phase 10 benchmark-gated), `2026-05-13-values-structural-reduction.md` (Tier A.1 Phases 0–4, PRs #747–#752), `2026-05-14-port-unification-design.md` / `-impl.md` (PR #749), `2026-05-14-numeric-registry-design.md` / `-impl.md` (PR #752), `2026-05-14-numeric-loss-signals-design.md` / `-impl.md` (PRs #753–#756). `2026-06-02-environment-frame-hot-cold-layout.md` (closed — Phase 0 done, Phases 1–3 declined) and `2026-06-04-parser-depth-limit-impl.md` (parser stack-overflow fix, security audit #1) also moved.)
...
| `2026-05-30-sat-solver-design.md` / `-impl.md` | CDCL SAT solver extension; closes axiomatic-equivalence gap via `boolean-decide-equivalent?` (moved to `memory/`) | Shipped |
| `2026-05-31-interval-dataflow-widening-design.md` / `-impl.md` | Interval dataflow + widening + pre-built Galois connections; wires `fixpoint/widen` into the MFP worklist solver (moved to `memory/`) | PR #765 |
| `2026-05-24-approximate-counting-semirings.md` | `saturating-`/`modular-`/`log-counting-semiring` — bounded-carrier counting variants that converge on cycles (moved to `memory/`) | commit `83763da9` |
| `2026-05-24-bignum-allocation-reduction.md` | In-place `values/numeric_scratch.go` scratch API + `bigint-counting-semiring` (Sub-path 4A) (moved to `memory/`) | PR #758 |
| `2026-05-26-scc-condensation.md` | SCC condensation for exact path-counting per cyclic component (moved to `memory/`) | PR #757 |
| `2026-05-27-graph-cyclic-dispatch-impl.md` | `#f`-as-cyclic dispatch contract for graph counting (moved to `memory/`) | PR #759 |
...
| `2026-05-29-car-cdr-consolidation.md` | `Car`/`Cdr` accessor consolidation; Pair.ForEach → Spine refactor (moved to `memory/`) | Shipped |
| `2026-05-29-repeated-stanzas-audit.md` | Sweep for short repeated code stanzas (FormParts/Uncons/Spine helper extractions) (moved to `memory/`) | Shipped |
