...
| `2026-04-20-paramtypes-audit-design.md` | Phase 5 design: audit `ParamTypes` across 500 primitives; per-slot analysis, extractor table, declared-too-narrow is load-bearing under Phase-2 enforcement | **Phase 5.A shipped (PR #678). Phase 5.B shipped: analyzer at `audit/wile-axis-b-params.scm`; outputs `plans/paramtypes-raw.scm` + `plans/2026-04-20-paramtypes-inventory.md` (71 Single-strict, 110 Single-coercing, 3 Declared-too-narrow (all FP — post-gate filters), 107 Declared-too-wide, 13 Union, 93 Variadic-rest, 79 Unguarded (16%, below kill criterion)). §7.3 deferred until 5.C** |
