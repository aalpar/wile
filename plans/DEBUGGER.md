...
**Status:** PROPOSED
**Date:** 2026-02-17
**Related:** Breakpoint Snap-to-Next (below), `machine/debugger.go`
...
The Breakpoint Snap-to-Next plan (below) proposes resolving breakpoints on optimized-away lines to the nearest executable line. That plan's Option B (template registry) is exactly the registry introduced here. The two plans share infrastructure:
...
### Option C: Lazy Resolution at Check Time (Correct) — RECOMMENDED
