...
**Status: COMPLETE** — All 12 tasks shipped. Commits `69b98203`..`78bb7e2f` on `feat/scheme-coverage` branch. 60 tests passing in `test/wile/algebra-polynomial-test.scm`.
...
- [x] **Step 2: Create library skeleton `polynomial.sld`**
...
- [x] **Step 3: Create `polynomial.scm` with record type and normalizing constructor**
...
- [x] **Step 5: Propose commit to user — do not commit automatically**
...
- [x] **Step 3: Extend `polynomial.sld` exports**
...
- [x] **Step 4: Implement in `polynomial.scm`**
...
- [x] **Step 3: Update exports in `polynomial.sld`**
...
- [x] **Step 3: Export `poly-derivative`**
...
- [x] **Step 3: Update `polynomial.sld`**
...
- [x] **Step 3: Export `polynomial-ring`**
...
- [x] **Step 3: Export `with-polynomial`**
...
- [x] **Step 1: Read existing differential test to understand impact**
...
- [x] **Step 2: Add `(wile algebra polynomial)` import to `differential.sld`**
...
- [x] **Step 3: Replace `polynomial-derivation` body in `differential.scm:77-142`**
...
- [x] **Step 4: Update `test/wile/algebra-differential-test.scm`**
...
- [x] **Step 1: Add failing tests for pre-built instances**
...
- [x] **Step 3: Add instances to `polynomial.scm`**
...
- [x] **Step 4: Update `polynomial.sld` exports**
...
- [x] **Step 5: Update `stdlib/lib/wile/algebra.sld` aggregator**
...
- [x] **Step 7: Full Scheme test suite**
...
- [x] **Step 8: Go lint clean (defensive — no Go changed, but verify)**

Run: `make lint`
Expected: pass.

- [x] **Step 9: Propose final commit**
