...
| F2 | COMPLETE | ✓ 2026-03-01 | Part A: opcode checklist at `opcode.go:22`. Part B: `invokeTransformerClosure()` helper in `expander_time_continuation.go` unifies both dispatch sites. |
