...
func addAtomic(r *registry.PrimitiveRegistry) error {
	r.AddPrimitives([]registry.PrimitiveSpec{
		...
		{Name: "atomic-load", ParamCount: 1, Impl: PrimAtomicLoad,
			...
			ParamTypes: []values.TypeConstraint{values.TypeAny}, ReturnType: values.TypeAny},
		{Name: "atomic-store!", Mutates: true, ParamCount: 2, Impl: PrimAtomicStore,
		...
		{Name: "atomic-swap!", Mutates: true, ParamCount: 2, Impl: PrimAtomicSwap,
		...
		{Name: "atomic-compare-and-swap!", Mutates: true, ParamCount: 3, Impl: PrimAtomicCompareAndSwap,
