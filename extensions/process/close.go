...
// processSpawnImpl returns the engine-scoped process-spawn: spawnProcess
// followed by tracking the child it started. A spawn that failed never reaches
// track.
//
// A func literal, not the bound method value p.primProcessSpawn: a method value
...
func (p *liveProcs) processSpawnImpl() machine.ForeignFunction {
