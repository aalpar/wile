...
func addPrimitives(r *registry.PrimitiveRegistry) error {
	r.AddPrimitives([]registry.PrimitiveSpec{
		...
		{Name: "call-with-input-file", InvokesProcedure: true, ParamCount: 2, Impl: PrimCallWithInputFile,
		...
		{Name: "call-with-output-file", InvokesProcedure: true, ParamCount: 2, Impl: PrimCallWithOutputFile,
