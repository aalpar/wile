...
|----------|------|----------|--------|-------|
| P2 | Performance refactoring (8 phases) | Performance | In Progress | Phase 1-3 complete, Phase 4.1-4.3 complete (structural sharing + WithScope idempotency). Phase 4.4: context pooling next. `plans/PERFORMANCE_REFACTORING_PLAN.md` |
