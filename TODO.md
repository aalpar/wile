...
|----------|------|----------|--------|-------|
| P2 | Performance refactoring (8 phases) | Performance | In Progress | Phase 1-4 complete. Phase 5 (compiler optimizations) next. `plans/PERFORMANCE_REFACTORING_PLAN.md` |
