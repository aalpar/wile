...
| `2026-08-03-algebra-egraph-design.local.md` | Design proposed, 5 phases, **not started**. Q1 (fund Phase 4 e-matching, which touches shared `rewrite.scm`) blocking; recommendation is to stop at Phase 3 and measure |
