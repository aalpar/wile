...
**Libraries**: (chibi test), (chibi optional), (chibi diff), (chibi term ansi), (srfi 1), (srfi 13), (srfi 132), (wile strings), (wile algebra) complete including `(wile algebra polynomial)` (ring-parameterized univariate polynomials); stdlib embedded in binary
