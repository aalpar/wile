...
**30+ benchmarks** covering recursion, allocation, floating-point, list processing, and more. See [benchmarks/README.md](benchmarks/README.md) for the complete list and cross-implementation comparison scripts.
