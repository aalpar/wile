...
// PrimCharGt implements the (char>?) primitive.
// Returns #t if the first character is greater than the second, #f otherwise.
func PrimCharGt(_ context.Context, mc *machine.MachineContext) error {
