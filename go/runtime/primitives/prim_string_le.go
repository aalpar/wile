...
// PrimStringLe implements the string<=? primitive.
// Returns #t if the first string is less than or equal to the second string.
func PrimStringLe(_ context.Context, mc *machine.MachineContext) error {
