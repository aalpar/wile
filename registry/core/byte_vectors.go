...
func addBytevectors(r *registry.Registry) error {
	r.AddPrimitives([]registry.PrimitiveSpec{
		{Name: "make-bytevector", ParamCount: 2, IsVariadic: true, Impl: PrimMakeBytevector,
			...
			ParamTypes: []values.TypeConstraint{values.TypeExactInteger, values.TypeExactInteger}, ReturnType: values.TypeByteVector},
		{Name: "bytevector", ParamCount: 1, IsVariadic: true, Impl: PrimBytevector,
			...
			ParamTypes: []values.TypeConstraint{values.TypeExactInteger}, ReturnType: values.TypeByteVector},
		...
		{Name: "bytevector-u8-set!", ParamCount: 3, Impl: PrimBytevectorU8Set,
			...
			ParamTypes: []values.TypeConstraint{values.TypeByteVector, values.TypeExactInteger, values.TypeExactInteger}, ReturnType: values.TypeVoid},
		{Name: "bytevector-copy", ParamCount: 2, IsVariadic: true, Impl: PrimBytevectorCopy,
			...
			ParamTypes: []values.TypeConstraint{values.TypeByteVector, values.TypeExactInteger}, ReturnType: values.TypeByteVector},
		{Name: "bytevector-copy!", ParamCount: 4, IsVariadic: true, Impl: PrimBytevectorCopyBang,
			...
			ParamTypes: []values.TypeConstraint{values.TypeByteVector, values.TypeExactInteger, values.TypeByteVector, values.TypeExactInteger}, ReturnType: values.TypeVoid},
	...
	r.AddPrimitives([]registry.PrimitiveSpec{
		{Name: "utf8->string", ParamCount: 2, IsVariadic: true, Impl: PrimUtf8ToString,
			...
			ParamTypes: []values.TypeConstraint{values.TypeByteVector, values.TypeExactInteger}, ReturnType: values.TypeString,
