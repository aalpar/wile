...
func addVectors(r *registry.Registry) error {
	r.AddPrimitives([]registry.PrimitiveSpec{
		...
		{Name: "vector-map", ParamCount: 2, IsVariadic: true, Impl: PrimVectorMap,
			Doc: "Applies proc element-wise and returns a vector of results.", ParamNames: []string{"proc", "vector"}, Category: "vectors"},
		{Name: "vector-for-each", ParamCount: 2, IsVariadic: true, Impl: PrimVectorForEach,
			Doc: "Applies proc element-wise for side effects.", ParamNames: []string{"proc", "vector"}, Category: "vectors"},
