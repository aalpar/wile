...
func addHashtables(r *registry.Registry) error {
	r.AddPrimitives([]registry.PrimitiveSpec{
		{Name: "make-hashtable", Impl: PrimMakeHashtable,
			Doc: "Returns a new empty hashtable using equal? for key comparison.", Category: "hashtables",
		...
		{Name: "hashtable-ref", ParamCount: 3, IsVariadic: true, Impl: PrimHashtableRef,
			Doc: "Returns the value associated with key in ht. If key is not found, returns default (or raises an error if no default given).", ParamNames: []string{"ht", "key", "default"}, Category: "hashtables",
		...
		{Name: "hashtable-set!", ParamCount: 3, Impl: PrimHashtableSet,
			Doc: "Associates key with value in ht, replacing any existing entry for key.", ParamNames: []string{"ht", "key", "value"}, Category: "hashtables",
		...
		{Name: "hashtable-delete!", ParamCount: 2, Impl: PrimHashtableDelete,
			Doc: "Removes the entry for key from ht. Does nothing if key is not present.", ParamNames: []string{"ht", "key"}, Category: "hashtables",
		...
		{Name: "hashtable-keys", ParamCount: 1, Impl: PrimHashtableKeys,
			Doc: "Returns a list of all keys in ht. The order is unspecified.", ParamNames: []string{"ht"}, Category: "hashtables",
		...
		{Name: "hashtable-values", ParamCount: 1, Impl: PrimHashtableValues,
			Doc: "Returns a list of all values in ht. The order corresponds to hashtable-keys.", ParamNames: []string{"ht"}, Category: "hashtables",
			ParamTypes: []values.ValueType{values.TypeHashtable}, ReturnType: values.TypeList},
		{Name: "hashtable-size", ParamCount: 1, Impl: PrimHashtableSize,
			Doc: "Returns the number of key-value pairs in ht.", ParamNames: []string{"ht"}, Category: "hashtables",
		...
		{Name: "hashtable-copy", ParamCount: 1, Impl: PrimHashtableCopy,
			Doc: "Returns a shallow copy of ht. Keys and values are shared with the original.", ParamNames: []string{"ht"}, Category: "hashtables",
		...
		{Name: "hashtable-clear!", ParamCount: 1, Impl: PrimHashtableClear,
			Doc: "Removes all entries from ht, leaving it empty.", ParamNames: []string{"ht"}, Category: "hashtables",
