...
func TestNumbers_BinaryLiterals(t *testing.T) {
	tcs := []struct {
	...
	}{
		{
			...
			numberType:    TokenizerStateUnsignedIntegerBase2,
			numberText:    "101",
			expectEOFNext: true,
		},
		{
			...
			input:         "#b-101",
			markerType:    TokenizerStateMarkerBase2,
			numberType:    TokenizerStateSignedIntegerBase2,
			numberText:    "-101",
			expectEOFNext: true,
		},
		{
...
func TestNumbers_OctalLiterals(t *testing.T) {
	tcs := []struct {
	...
	}{
		{
			...
			input:      "#o177",
			numberType: TokenizerStateUnsignedIntegerBase8,
			numberText: "177",
		},
		{
			name:       "signed negative octal",
			input:      "#o-77",
			numberType: TokenizerStateSignedIntegerBase8,
			numberText: "-77",
		},
		{
...
func TestNumbers_HexLiterals(t *testing.T) {
	tcs := []struct {
	...
	}{
		{
			...
			input:      "#xFF",
			numberType: TokenizerStateUnsignedIntegerBase16,
			numberText: "FF",
		},
		{
		...
		},
		{
			...
			input:      "#x-1A",
			numberType: TokenizerStateSignedIntegerBase16,
			numberText: "-1A",
		},
		{
...
func TestNumbers_HashDigits(t *testing.T) {
	tcs := []struct {
		...
		},
		{
			...
			input:      "#b1#",
			state:      TokenizerStateUnsignedIntegerBase2,
			text:       "1#",
			hasHash:    true,
			usePrefix:  true,
			markerType: TokenizerStateMarkerBase2,
		},
		{
			...
			input:      "#xf#",
			state:      TokenizerStateUnsignedIntegerBase16,
			text:       "f#",
			hasHash:    true,
			usePrefix:  true,
...
func TestNumbers_DecimalPrefix(t *testing.T) {
	tcs := []struct {
	...
	}{
		{
			...
			input:      "#d42",
			numberType: TokenizerStateUnsignedIntegerBase10,
			numberText: "42",
		},
		{
			name:       "decimal prefix signed negative",
			input:      "#d-42",
			numberType: TokenizerStateSignedIntegerBase10,
			numberText: "-42",
		},
		{
