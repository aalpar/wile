...
func addReadWrite(r *registry.Registry) error {
	r.AddPrimitives([]registry.PrimitiveSpec{
		...
		{Name: "read-string", ParamCount: 2, IsVariadic: true, Impl: PrimReadString,
			...
			ParamTypes: []values.TypeConstraint{values.TypeInteger, values.TypeTextualInputPort}},
		...
		{Name: "read-bytevector", ParamCount: 2, IsVariadic: true, Impl: PrimReadBytevector,
			...
			ParamTypes: []values.TypeConstraint{values.TypeInteger, values.TypeBinaryInputPort}},
		{Name: "read-bytevector!", ParamCount: 2, IsVariadic: true, Impl: PrimReadBytevectorBang,
			...
			Keywords:   []string{"get-bytevector-n!"},
			ParamTypes: []values.TypeConstraint{values.TypeByteVector, values.TypeBinaryInputPort}},
...
func addPorts(r *registry.Registry) error {
	...
	r.AddPrimitives([]registry.PrimitiveSpec{
		...
		// With no argument, constructs a fresh buffered bytevector output
