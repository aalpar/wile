...
- [ ] `values/big_complex.go:99` `toBigFloat` — Tier 3 helper used by BigComplex for `.Float64()` conversions at the FFI boundary; verify no dispatch-path uses remain after #362
